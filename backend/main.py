...
from app.api.routes import races, horses, betting, ai_advisor, education, tracksense, simulator, alerts, affiliate, auth, accuracy, admin_cost, contest, watchlist, people
