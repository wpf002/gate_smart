...
class HorsePastPerformance(Base):
    ...
    # Horse identity
    horse_name_key: Mapped[str] = mapped_column(String(120), nullable=False)
    ...
    card_date: Mapped[Optional[str]] = mapped_column(String(10))
    card_track_code: Mapped[str] = mapped_column(String(10), default="")
    card_race_number: Mapped[int] = mapped_column(Integer, default=0)
    ...
    # Past race identity
    pp_track_code: Mapped[str] = mapped_column(String(10), default="")
    pp_race_date: Mapped[Optional[str]] = mapped_column(String(10))
    pp_race_number: Mapped[int] = mapped_column(Integer, default=0)
    ...
    # Figures (Beyer-comparable scale after ÷10 from raw XML)
    speed_figure: Mapped[Optional[int]] = mapped_column(Integer, nullable=True)
    pace_figure_1: Mapped[int] = mapped_column(Integer, default=0)
    pace_figure_2: Mapped[int] = mapped_column(Integer, default=0)
    pace_figure_3: Mapped[int] = mapped_column(Integer, default=0)
    class_rating: Mapped[int] = mapped_column(Integer, default=0)

    # Result
    official_finish: Mapped[int] = mapped_column(Integer, default=0)
    post_position: Mapped[int] = mapped_column(Integer, default=0)
...
class HorseResultChart(Base):
    ...
    # Race identity
    track_code: Mapped[str] = mapped_column(String(10), default="")
    track_name: Mapped[str] = mapped_column(String(80), default="")
    race_date: Mapped[Optional[str]] = mapped_column(String(10))
