...
export default function RaceDetailPage() {
  ...
  const { data: race, isLoading } = useQuery(['race', raceId], () => getRaceDetail(raceId));

  const analyzeMutation = useMutation(
    () => analyzeRace(raceId, analysisMode, userProfile.bankroll),
    ...
    <div>
      ...
      <div style={{ padding: '16px' }}>
        ...
        <div style={{ marginBottom: 16 }}>
          {!analysis && !analyzeMutation.isLoading && (
            <div>
              <div style={{ marginBottom: 10 }}>
          ...
          <AnalysisPanel analysis={analysis} loading={analyzeMutation.isLoading} />
        </div>
